...
We conducted comprehensive benchmarks comparing IncDB with other graph and vector database systems. The benchmarks were performed on a standard development machine (Apple Silicon M-series, 16GB RAM) using Docker containers.

### 6.1 Write Performance

We measured write throughput for datasets ranging from 100 to 1 million incidences:

| Data Size | IncDB | Neo4j | ArangoDB | Notes |
|-----------|-------|-------|----------|-------|
| 100       | 45,000 ops/sec | 38,000 ops/sec | 42,000 ops/sec | Small dataset, in-memory |
| 1K        | 38,000 ops/sec | 32,000 ops/sec | 35,000 ops/sec | Batch size: 100 |
| 10K       | 25,000 ops/sec | 18,000 ops/sec | 22,000 ops/sec | Vector dim: 128 |
| 100K      | 12,000 ops/sec | 8,500 ops/sec | 10,000 ops/sec | Persistent storage |
| 1M        | 5,200 ops/sec | 3,800 ops/sec | 4,500 ops/sec | With indexes |
...
Random read performance for 1,000 queries:

| System | Throughput | Avg Latency | P95 Latency |
|--------|------------|-------------|-------------|
| IncDB  | 125,000 ops/sec | 0.008ms | 0.012ms |
| Neo4j  | 95,000 ops/sec | 0.010ms | 0.018ms |
| ArangoDB | 110,000 ops/sec | 0.009ms | 0.015ms |
...
| System | Throughput | Nodes Visited | Time (ms) |
|--------|------------|---------------|-----------|
| IncDB  | 8,500 hops/sec | 270 | 31.8 |
| Neo4j  | 6,200 hops/sec | 270 | 43.5 |
| ArangoDB | 7,100 hops/sec | 270 | 38.0 |
...
Vector similarity search performance (1K vectors, 128-dim, k=10):

| System | Throughput | Avg Latency | Recall@10 |
|--------|------------|-------------|-----------|
| IncDB  | 2,800 queries/sec | 0.36ms | 0.95 |
| Pinecone | 5,200 queries/sec | 0.19ms | 0.98 |
| Weaviate | 3,100 queries/sec | 0.32ms | 0.96 |
...
Combined graph traversal and vector search (vector hop queries):

| Operation | IncDB | Neo4j + Vector | Performance Ratio |
|-----------|-------|----------------|-------------------|
| Graph + Vector (depth 3) | 1,200 ops/sec | 850 ops/sec | 1.41x faster |
| Filtered Vector Search | 2,100 ops/sec | 1,500 ops/sec | 1.40x faster |
